...
# Creating the rectangle box for capturing the hand gestures
# and displaying the outputs and probabilities to the user.
# The rectangle will be drawn on the video feed to indicate the area of interest.
...
sentence = []     # Stores detected words/actions
accuracy = []     # Stores confidence % of last recognized action
predictions = []  # Raw class predictions (0,1,2,...)
threshold = 0.8  # Set a threshold for gesture recognition confidence, # Minimum confidence to accept a gesture
...
with mp_hands.Hands(
    ...
    # https://chatgpt.com/share/688606b3-47a4-800c-ab90-66347803f345
