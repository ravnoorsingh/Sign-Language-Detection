...
for action in actions:
    ...
    # 30 such sequesces
    # 1 sequence = 30 images at once ---> 1 gesture video clip
    # we wnat our model to understand what video clip is
...
# https://chatgpt.com/share/6885fd75-7e14-800c-8701-cf3386803183
